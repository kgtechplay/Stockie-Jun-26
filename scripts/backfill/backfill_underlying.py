# scripts/backfill/backfill_underlying.py
"""
...
def main() -> None:
    ...
    parser.add_argument("--type", choices=["INDEX", "STOCK"], required=True, help="WatchedInstrument instrument_type")
    ...
    parser.add_argument("--underlying", default=None, help="Optional comma-separated underlyings")
