...
Input files: output/historical/{UNDERLYING}_{strategy}.csv
  e.g., output/historical/NIFTY_trendFollowing.csv
...
PRED_DIR = os.path.join("output", "historical")
PRED_FILE_PATTERN = "{underlying}_{strategy}.csv"
...
def backtest_index_prediction(filename: str, underlying: str) -> bool:
    ...
    Args:
        filename: Name of the prediction file (e.g., "NIFTY_trendFollowing.csv")
...
def calculate_summary(filename: str) -> dict:
    ...
    try:
        ...
        # Format: {UNDERLYING}_{strategy}.csv
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        ...
        epilog="""
Backtests historical underlying prediction files:
  - Input: output/historical/{UNDERLYING}_{strategy}.csv
