...
class SignalFeatureDaily:
    ...
    trend_efficiency_60d: float | None = None
    ...
    range_position_5d: float | None = None
    range_position_10d: float | None = None
    range_position_20d: float | None = None
