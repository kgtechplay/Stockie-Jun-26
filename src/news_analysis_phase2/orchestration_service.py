...
from src.news_analysis_phase2.dailyNews.agent import DailyNewsAgent
from src.news_analysis_phase2.impactList.agent import ImpactListAgent
from src.news_analysis_phase2.reviewList.agent import ReviewListAgent
from src.news_analysis_phase2.signal_normalizer import (
    FinalizedTradeSignal,
    normalize_review_signals,
    persist_signal_journal,
)
from src.news_analysis_phase2.backtest.news_underlying_backtest import NewsBacktestRequest, run_news_underlying_backtest
from src.news_analysis_phase2.sector_expansion_service import SectorExpansionService
...
class OrchestrationService:
    ...
    def default(cls) -> "OrchestrationService":
        ...
        return cls(
            ...
            review_config_path=project_root / "src" / "news_analysis_phase2" / "reviewList" / "config.yaml",
        )
    ...
    def _run_backfill_for_signals(
        ...
        try:
            return {
                "triggered": False,
                "reason": "Phase 2 news backfill is parked; run scripts/backfill_NIFTY jobs manually when revisiting news analysis.",
                "underlyings": symbols,
                "start_date": start_date.isoformat(),
                "end_date": end_date.isoformat(),
            }
